  ...
  ((|:MUL3X3| (MUL3X3 |sym2| A B C)
    (:FIXH
     ((|:MUL3X3-JI| (MUL3X3-JI |sym3| J0 I0)
       (:RECORD-REF (MUL3X3-JI 4) (A)
        ((:RECORD-REF (MUL3X3-JI 3) (B)
          ((:RECORD-REF (MUL3X3-JI 2) (C)
            ((:* (I0 3) (|sym8|)
      ...
      (|:MUL3X3-J| (MUL3X3-J |sym9| J I0)
       (:FIXH
        ((|:MUL3X3-J-I0| (MUL3X3-J-I0 |sym10| J)
          (:RECORD-REF (MUL3X3-J-I0 2) (MUL3X3-JI)
                        ...
                        ((:RECORD-REF (|sym15| 1) (|sym17|)
                          ((:POP (4) NIL
                            ((:RECORD-REF (MUL3X3-J-I0 0) (|k-sym3|)
                              ((:APP |k-sym3|
                                (MUL3X3-J-I0 |sym10| |sym17|))))))))))))))
                   (:STACK ((:LABEL |:sym15|) |sym17| |sym10| MUL3X3-J-I0)
                    (|sym15|)
                    ((:RECORD-REF (MUL3X3-JI 0) (|k-sym4|)
                      ((:APP |k-sym4| (MUL3X3-JI |sym15| J I0)))))))))))))))))
    (:HEAP ((:LABEL |:MUL3X3-J-I0|) I0 MUL3X3-JI) (MUL3X3-J-I0)
     ((:RECORD-REF (MUL3X3-J-I0 0) (|k-sym5|)
       ((:APP |k-sym5| (MUL3X3-J-I0 |sym9| J))))))))
    (|:MUL3X3-I| (MUL3X3-I |sym20| I)
     (:RECORD-OFFS (MUL3X3-I 2) (MUL3X3-J)
      ((:= (I 3) NIL
        ((:RECORD-REF (|sym20| 0) (|k-sym6|)
          ((:APP |k-sym6| (|sym20| :|#T|))))
         (:+ (I 1) (|sym27|)
          ((:FIXS
            ((|:sym25| (|sym25| |sym26|)
                 ...
                 ((:RECORD-REF (|sym25| 1) (|sym27|)
                   ((:POP (4) NIL
                     ((:RECORD-REF (MUL3X3-I 0) (|k-sym7|)
                       ((:APP |k-sym7| (MUL3X3-I |sym20| |sym27|))))))))))))))
            (:STACK ((:LABEL |:sym25|) |sym27| |sym20| MUL3X3-I) (|sym25|)
             ((:RECORD-REF (MUL3X3-J 0) (|k-sym8|)
               ((:APP |k-sym8| (MUL3X3-J |sym25| I)))))))))))))))
    (:HEAP
     ((:LABEL |:MUL3X3-I|) (:LABEL |:MUL3X3-JI|) (:LABEL |:MUL3X3-J|) C B A)
     (MUL3X3-I)
     ((:RECORD-REF (MUL3X3-I 0) (|k-sym9|)
       ((:APP |k-sym9| (MUL3X3-I |sym2| 0 0)))))))))
(:HEAP ((:LABEL |:MUL3X3|)) (|k-sym11|)
 ((:RECORD-REF (EXIT 0) (|k-sym10|) ((:APP |k-sym10| (EXIT :UNSPECIFIED))))))))
